...
typedef struct
{
    //en un fd real mas complejo , tenemos un puntero a las
    //operaciones que se pueden hacer en ese fd (sus drivers)
...
/*
 * Gets all open file descriptors.
 * Parameters:
 *   fds - Array to store the open file descriptor numbers.
 * Returns the number of open file descriptors.
 */
int getFileDescriptors(int *fds);
//revisar si hace falta esta funcion!!!!!!
